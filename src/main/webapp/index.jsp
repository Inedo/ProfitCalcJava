<%@ page import="java.text.NumberFormat,java.text.Format" %>
	...
	<div id="page">
		<div id="page-bgtop">
				...
				<div class="post">
                    ...
                    <table cellpadding="0" cellspacing="0" align="center">
                        ...
                        <tbody>
                            <tr>
                                <td>Revenue</td>
								<td><input type="text" name="revenue" value="<%= request.getParameter("revenue") == null ? "0.00" : request.getParameter("revenue") %>" /></td>
                            </tr>
                            <tr>
                                <td>Expenses</td>
                                <td><input type="text" name="expenses" value="<%= request.getParameter("expenses") == null ? "0.00" : request.getParameter("expenses") %>" /></td>
                            </tr>
                            <tr>
                                <td>Net Profit</td>
                                <td>
                                <%
                                    try {
                                        ...
                                        out.println ( formatter.format(revenue - expenses) );
                                    }
                                    catch (Exception e) {
                                        NumberFormat formatter = NumberFormat.getCurrencyInstance();
                                        out.println ( formatter.format(0.00) );
                                    }
                                 %>
                                </td>
                            </tr>
			...
			<div id="sidebar">
                ...
                Configuration value: <br /><strong> <%= request.getParameter("config_value")%> </strong>
                </div>
                <div id="version" class="sideBox">
                Version: <br /><strong>${project.version}</strong>
                </div> -->
			</div>
			<!-- end div#sidebar -->
